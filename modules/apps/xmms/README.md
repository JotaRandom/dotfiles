...
1. En sistemas con `stow` y el instalador, `./scripts/install.sh modules/apps/xmms` colocará el archivo de configuración en `~/.xmms2rc` o `~/.xmms2/config` según la estructura del usuario.
