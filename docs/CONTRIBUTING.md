...
Reglas básicas:
 - Si añades dotfiles nuevos que sean globales (bash, zsh, tmux), colócalos en `modules/<role>` y asegúrate que son compatibles con el instalador `install.sh`.
...
2. Añadir cambios pequeños y testear `install.sh` si aplicable.
